            ...
            <div class="crypto-card" style="background: linear-gradient(135deg, {{ $gradient }}, {{ $gradient2 }});">
                ...
                <p>
                    ...
                    <span>
                        ...
                        <span class="prix" data-fcfa="{{ $produit->prix }}"></span>
                    </span>
                </p>
                ...
                <p>
                    ...
                    <span>
                        {{ number_format($produit->revenu, 0, ',', ' ') }} FCFA
                        <span class="revenu" data-fcfa="{{ $produit->revenu }}"></span>
                    </span>
                </p>
                ...
                <p>
                    ...
                    <span>
                        {{ number_format($produit->revenu * 40, 0, ',', ' ') }} FCFA
                        <span class="revenu" data-fcfa="{{ $produit->revenu * 40 }}"></span>
                    </span>
                </p>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Conversion des FCFA en USD
    document.querySelectorAll(".prix, .revenu").forEach(el => {
        const fcfa = parseFloat(el.getAttribute("data-fcfa")) || 0;
        const usd = fcfa / taux;
        el.innerHTML = `(≈ ${formatNombre(usd)} $)`;
    });
